...
\input{parts/1.tong_quan.tex}
\input{parts/2.cac_cong_trinh_nghien_cuu_lien_quan.tex}
\input{parts/3.co_so_ly_thuyet.tex}
\input{parts/4.phuong_phap_de_xuat.tex}
\input{parts/5.thuc_nghiem.tex}
\input{parts/6.ket_luan.tex}
