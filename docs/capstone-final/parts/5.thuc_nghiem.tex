...
\texttt{concept-other.txt} & Lưu trữ mối quan hệ giữa các khái niệm và các tài liệu, tài nguyên ngoại khóa được thu thập từ các nguồn bên ngoài khóa học & \texttt{concept ID\tresource ID} & 1.2MB \\ \hline
\texttt{concept-paper.txt} & Lưu trữ mối quan hệ giữa các khái niệm và các bài báo khoa học có liên quan & \texttt{concept ID\tpaper ID} & 613KB \\ \hline
\texttt{concept-problem.txt} & Lưu trữ mối quan hệ giữa các khái niệm và các câu hỏi hoặc bài tập liên quan & \texttt{concept ID\tquestion ID} & 8.7MB \\ \hline
\texttt{concept-video.txt} & Lưu trữ mối quan hệ giữa các khái niệm và các video liên quan & \texttt{concept ID\tccid} & 8.7MB \\ \hline
\texttt{concept-comment.txt} & Lưu trữ mối quan hệ giữa các khái niệm và các bình luận của người dùng có liên quan & \texttt{concept ID\treview ID} & 62KB \\ \hline
\end{tabular}%
}
