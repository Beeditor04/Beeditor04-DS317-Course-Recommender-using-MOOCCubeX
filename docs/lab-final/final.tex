...
% \hrule \\[0.4cm]
{\huge \bfseries BÀI THỰC HÀNH}\\[0.3cm]
...
\input{parts/1.bao_cao_phan_tich_du_lieu.tex}
\newpage
\input{parts/2.thuyet_minh_de_tai.tex}
\newpage
\input{parts/3.bo_du_lieu_sau_tien_xu_li.tex}
\newpage
