...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.485\linewidth]{image/8.png}
\end{figure}
\newpage
...
\begin{itemize}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.75\linewidth]{image/9.png}
    \end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{image/10.png}
\end{figure}\\
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{image/11.png}
\end{figure}\\
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.35\linewidth]{image/12.png}
\end{figure}
\newpage
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{image/13.png}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\linewidth]{image/14.png}
\end{figure}\\
\newpage
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{image/15.png}
\end{figure}
\newpage
Ta tiến hành thống kê đặc điểm từng cột có trong bảng:
\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{image/16.png}
    \caption{Số lượng users}
\end{figure}
\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{image/17.png}
    \caption{Cột “gender”}
\end{figure}
\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{image/18.png}
    \caption{Phân bố các các giá trị trong cột “gender”:}
\end{figure}
\newpage
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{image/19.png}
    \caption{Thông tin cột “school”}
\end{figure}
\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{image/20.png}
    \caption{Số lượng trường học trong bảng}
\end{figure}
\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{image/21.png}
    \caption{Kiểm tra thông tin tổng quan sau cùng}
\end{figure}
\newpage
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{image/22.png}
    \caption{Số lượng sample (users) có trong bảng và số lượng users thuộc về mỗi trường học}
\end{figure}
\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{image/23.png}
    \caption{Tạo một cột “school\_length” để phân tích độ dài mỗi sample của cột}
\end{figure}
\newpage
\begin{figure}
    \centering
    \includegraphics[width=0.68\linewidth]{image/24.png}
    \caption{Trực quan hóa độ dài của sample cột “school”}
\end{figure}
\begin{figure}[h]
    \centering
    \includegraphics[width=0.68\linewidth]{image/25.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\linewidth]{image/27.png}
\end{figure}\\
Tham khảo phân phối của top 10 tên việc xuất hiện nhiều nhất trong bảng
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{image/28.png}
\end{figure}\\
Tham khảo phân phối của top 10 tổ chức xuất hiện nhiều nhất trong bảng
\newpage
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{image/29.png}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\linewidth]{image/30.png}
\end{figure}
\newpage
\begin{figure}
    \centering
    \includegraphics[width=0.65\linewidth]{image/31.png}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{image/32.png}
    \caption{Histogram thể hiện số lượng khóa học của mỗi teacher và bảng thống kê mô tả tương ứng}
\end{figure}
\newpage
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{image/33.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{image/34.png}
\end{figure}\\
Kiểm tra kiểu dữ liệu của từng cột: 
\newpage
\begin{figure}
    \centering
    \includegraphics[width=0.6\linewidth]{image/35.png}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.65\linewidth]{image/36.png}
\end{figure}
\newpage
Có 2 cột ta cần là “about\_length” và “motto\_length” để ta tìm phân bố độ dài của giá trị lên đồ thị:
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{image/37.png}
\end{figure}\\
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{image/38.png}
\end{figure}\\
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{image/39.png}
    \caption{Tổng số lượng khóa học và tổng số lượng các lĩnh vực khác nhau}
\end{figure}
\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{image/40.png}
    \caption{Phân bố số lượng khóa học theo từng lĩnh vực}
\end{figure}
\newpage
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{image/41.png}
    \caption{Phân bố độ dài tên khóa học}
\end{figure}
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\linewidth]{image/42.png}
    \caption{Biểu đồ thanh thể hiện sự phân bố số lượng khóa học theo từng lĩnh vực}
\end{figure}
\newpage
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{image/44.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{image/26.png}
\end{figure}
\newpage
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{image/45.png}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{image/46.png}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{image/47.png}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{image/48.png}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{image/49.png}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{image/50.png}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{image/51.png}
\end{figure}\\
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{image/52.png}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\linewidth]{image/53.png}
\end{figure}
\newpage
\begin{itemize}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\linewidth]{image/54.png}
\end{figure}\\
